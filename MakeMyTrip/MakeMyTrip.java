class MakeMyTrip
{
	...
	MakeMyTrip(String appName, float version)
	{
	...
	void displayDeveloperCountryStateSize()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address3  address =developer.addresses[i];
				String street = address.street ;
				Country3 cont = address.country;
				State3[] states = cont.states;
	...
	void displayDeveloperCountry()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address3 address= developer.addresses[k];
	...
	void displayDeveloperCityName()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address3 address = developer.addresses[x];
				Country3 country = address.country;
