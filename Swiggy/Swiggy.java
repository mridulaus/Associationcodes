class Swiggy
{
	...
	Swiggy(String appName, float version)
	{
	...
	void displayDeveloperCountryStateSize()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address6  address =developer.addresses[i];
				String street = address.street ;
				Country6 cont = address.country;
				State6[] states = cont.states;
	...
	void displayDeveloperAddressStreet()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address6  address = developer.addresses[j];
				String street = address.street;
	...
	void displayDeveloperCountry()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address6 address= developer.addresses[k];
	...
	void displayDeveloperCityName()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address6 address = developer.addresses[x];
				Country6 country = address.country;
				State6[] states = country.states;
				for(int index=0; index<states.length; index++)	
				{ 
					State6  state =states[index];
