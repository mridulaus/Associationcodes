class Uber
{
	...
	Uber(String appName, float version)
	{
	...
	void displayDeveloperCountryStateSize()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address4  address =developer.addresses[i];
				String street = address.street ;
				Country4 cont = address.country;
				State4[] states = cont.states;
	...
	void displayDeveloperCountry()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address4 address= developer.addresses[k];
	...
	void displayDeveloperCityName()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address4 address = developer.addresses[x];
				Country4 country = address.country;
