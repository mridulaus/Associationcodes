class Instagram
{
	...
	Instagram(String appName, float version)
	{
	...
	void displayDeveloperCountryStateSize()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address2  address =developer.addresses[i];
				String street = address.street ;
				Country2  cont = address.country;
				State2[] states = cont.states;
	...
	void displayDeveloperAddressStreet()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address2  address = developer.addresses[j];
				String street = address.street;
	...
	void displayDeveloperCountry()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address2  address= developer.addresses[k];
	...
	void displayDeveloperCityName()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address2  address = developer.addresses[x];
				Country2  country = address.country;
				State2[] states = country.states;
				for(int index=0; index<states.length; index++)	
				{ 
					State2 state =states[index];
