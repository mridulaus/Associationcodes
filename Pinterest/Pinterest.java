class Pinterest
{
	...
	Pinterest(String appName, float version)
	{
	...
	void displayDeveloperCountryStateSize()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address5  address =developer.addresses[i];
				String street = address.street ;
				Country5 cont = address.country;
				State5[] states = cont.states;
	...
	void displayDeveloperCountry()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address5 address= developer.addresses[k];
	...
	void displayDeveloperCityName()
	{
		if(this.developer.addresses!=null)
		{
			...
			{
				Address5 address = developer.addresses[x];
				Country5 country = address.country;
